...
def generate_launch_description():
    ...
    # Delay start of robot_controller after `fts_broadcaster_spawner`
    delay_joint_state_broadcaster_spawner_after_fts_broadcaster_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
    ...
    nodes = [
        ...
        delay_joint_state_broadcaster_spawner_after_fts_broadcaster_spawner,
